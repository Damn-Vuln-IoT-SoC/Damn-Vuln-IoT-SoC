...
from litex.soc.cores.vulns import AddTopSecretRegion
...
class SoCCore(LiteXSoC):
    ...
    def __init__(self, platform, clk_freq,
        ...
        **kwargs):
        ...
        # Add secret region
        AddTopSecretRegion.__init__(self)
    ...
    def add_memory_region(self, name, origin, length, type="cached"):
        ...
        self.bus.add_region(name, SoCRegion(origin=origin, size=length, cached=cached, linker=linker))
